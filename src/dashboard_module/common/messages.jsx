            ...
            <div className="min-h-screen max-w-screen-xl overflow-hidden xl:mx-auto">
                ...
                <div className="grid grid-cols-4 sm:grid-cols-10">
                    ...
                    <div className="col-span-2 relative hidden sm:block">
                        <div className="py-4 px-2">
                            <input
                                ...
                                className="py-2 px-2 outline outline-1 bg-red-50 rounded-2xl w-full"/>
                        </div>
                        <div
                    ...
                    <div className="col-span-8 overflow-hidden rounded-xl sm:bg-red-50 sm:px-8 sm:shadow">
                        <section>
                            <div className="flex sticky top-0 z-50 space-x-2  border-b  border-gray-300 bg-red-50 py-5 px-8 text-left text-sm  text-gray-800">
                                ...
                                <h4 className="py-1 text-left font-bold text-xl">Lara Abegnale</h4>
                            </div>
                            <div className="flex-grow px-8 pt-8 text-left text-gray-700">
                                ...
                                <div className="mt-4  flex items-start border-t  border-gray-300 sm:p-8 py-4 text-left  text-gray-700">
                                    ...
                                    className="mr-4 overflow-hidden w-full flex-1 cursor-text resize-none outline outline-1 whitespace-pre-wrap rounded-lg bg-red-50 text-sm py-2 sm:py-0 font-normal text-gray-600 "></textarea>

                                    <button className="button relative inline-flex h-10 w-auto flex-initial cursor-pointer items-center justify-center self-center  rounded-md px-6 text-center align-middle text-sm font-medium outline-none">Send</button>
                                </div>
                            </div>
                        </section>
                    </div>
