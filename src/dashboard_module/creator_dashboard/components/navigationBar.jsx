  ...
  return (
    <div>
      <div className="fixed z-50 md:relative">
        <nav aria-label="Sidebar Navigation" className="peer-checked:w-64 left-0 z-10 flex h-screen w-0 flex-col xs:hidden overflow-hidden bg-gray-700 text-white transition-all md:h-screen md:w-64 lg:w-72">
        ...
        <div className="sm:hidden fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 bottom-0 left-1/2 dark:bg-gray-700 dark:border-gray-600">
