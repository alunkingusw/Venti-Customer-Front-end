...
<div className="bg-black">
    <section className="fixed py-6 px-3 bg-black w-[245px] h-[100%] border-r-[1px] border-r-zinc-800">
      <div className="py-3 px-2">
        <svg aria-label="Instagram" className="_ab6-" color="#fafafa" fill="#fafafa" height="29" role="img"
      ...
      <nav>
        <ul className="h-[100%] flex flex-col text-base  space-y-4 py-7 text-white ">
            ...
            <button>
              <a href="#">
                <li className="pl-3 flex">
                  <svg aria-label="Home" className="_ab6-" color="#fafafa" fill="#fafafa" height="24" role="img"
                    viewBox="0 0 24 24" width="24">
                    <path
                      d="M22 23h-6.001a1 1 0 0 1-1-1v-5.455a2.997 2.997 0 1 0-5.993 0V22a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V11.543a1.002 1.002 0 0 1 .31-.724l10-9.543a1.001 1.001 0 0 1 1.38 0l10 9.543a1.002 1.002 0 0 1 .31.724V22a1 1 0 0 1-1 1Z">
                    </path>
                  </svg>
                  <p className="ml-4  text-[16px] font-sans">Página inicial</p>
                </li>
              </a>
            </button>
          </div>
          <div className="flex cursor-pointer rounded-3xl py-2 active:font-semibold hover:bg-gray-50 hover:bg-opacity-10">
            <button>
              <li className="pl-3 flex">
                <svg aria-label="Search" className="_ab6-" color="#fafafa" fill="#fafafa" height="24" role="img"
                  viewBox="0 0 24 24" width="24">
                ...
                <p className="ml-4 font-sans text-[16px]">Pesquisa</p>
              </li>
            </button>
          </div>
          <div className="flex cursor-pointer rounded-3xl py-2 active:font-semibold hover:bg-gray-50 hover:bg-opacity-10">
            <button>
              <li className="pl-3 flex">
                <svg aria-label="Explore" className="_ab6-" color="#fafafa" fill="#fafafa" height="24" role="img"
                  viewBox="0 0 24 24" width="24">
                ...
                <p className="ml-4 font-sans text-[16px]">Explorar</p>
              </li>
            </button>
          </div>
          <div className="flex cursor-pointer rounded-3xl py-2  active:font-semibold hover:bg-gray-50 hover:bg-opacity-10">
            <button>
              <li className="pl-3 flex">
                <svg aria-label="Reels" className="_ab6-" color="#fafafa" fill="#fafafa" height="24" role="img"
                  viewBox="0 0 24 24" width="24">
                ...
                <p className="font-sans text-[16px]  ml-4">Reels</p>
              </li>
            </button>
          </div>
          <div className=" flex cursor-pointer rounded-3xl py-2 active:font-semibold hover:bg-gray-50 hover:bg-opacity-10">
            <button id="btn-msg">
              <a href="#">
                <li className="flex pl-3 ">
                  <i className=" text-2xl  relative mr-4">
                ...
                <button
                  className="rounded-full top-[329px] text-center items-center right-[183px] absolute h-[18px] w-[23px] bg-red-600 text-white text-xs">
                  12
                </button>
              </a>
            </button>
          ...
          <div className="flex cursor-pointer rounded-3xl py-2 active:font-semibold hover:bg-gray-50 hover:bg-opacity-10">
            <button>
              <li className="pl-3 flex">
                ...
                <p className="ml-4 font-sans text-[16px]">
                  Notificações
                </p>
              </li>
            </button>
          ...
          <div className="flex cursor-pointer rounded-3xl py-2 active:font-semibold hover:bg-gray-50 hover:bg-opacity-10 ">
            <button>
              <li className="pl-3 flex">
                ...
                <p className="ml-4 font-sans text-[16px]">Criar</p>
              </li>
            </button>
          </div>
          <div className="cursor-pointer  flex  rounded-3xl mb-20 py-2 active:font-semibold hover:bg-gray-50 hover:bg-opacity-10">
            <img className="w-7 h-7 ml-2 rounded-full " src="https://avatars.githubusercontent.com/u/26464462?v=4" alt="" />
            <a href="#">
              <li className="pl-4">Perfil</li>
            </a>
          </div>
        </ul>
      </nav>
      <div className="flex cursor-pointer mt-[75px] text-xl rounded-3xl py-2 hover:bg-gray-50 hover:bg-opacity-10">
        <div className="pl-3 ">
          <div className="h-[2px] w-5 bg-white my-[6px] mr-4"></div>
          <div className="h-[2px] w-5 bg-white my-[6px] mr-4"></div>
          <div className="h-[2px] w-5 bg-white my-[6px] mr-4"></div>
        </div>
        <span>
          <p className="text-white text-base mt-1">Mais</p>
        </span>
      </div>
    </section>
    <section className="ml-[340px] w-[630px]">
      <div className="py-4">
        <div className="bg-black  mt-4 rounded-lg ">
          <div className="flex py-2 justify-between px-4">
            <div className="text-center">
              ...
              <p className="text-white text-xs pb-2 pt-1">fulano..</p>
            </div>
            <div className="text-center">
              <div className="rounded-full p-0.5 bg-gradient-to-r from-yellow-400 via-pink-500 to-red-500">
                <div className="h-14 w-14 rounded-full bg-white wrapper overflow-hidden border-2 border-black">
      ...
      <div className="bg-black rounded-lg">
        <div className="mb-4">
          <div className="flex flex-row items-center text-center gap-2">
            ...
            <p className="text-white text-sm font-semibold pb-2 pt-1">fulanodetal</p>
          </div>
          <div></div>
        </div>
        <div>
    ...
    <section className="absolute w-[400px] ml-[1050px] top-[30px] rounded-lg">
      <div className="py-3 flex space-x-3">
        <img className="w-[60px] h-[60px]  rounded-full" src="https://avatars.githubusercontent.com/u/26464462?v=4" alt="" />
        <div className="mt-2">
          <p className="text-white cursor-pointer">andrecanuto</p>
          <p className="text-gray-400">André Cabral</p>
        </div>
        <div>
          <p className="ml-[180px] mt-4 text-sm text-blue-500 cursor-pointer">
            Mudar
          </p>
        </div>
      </div>
      <div>
        <div className="py-3">
          <ul className="flex justify-between">
            <li className="text-gray-400">Sugestões para você</li>
            <li className="mr-[6px] text-white cursor-pointer">Ver tudo</li>
          </ul>
        </div>
      </div>
      <div className="space-y-2">
        <div className="flex space-x-3">
          <img className="w-[30px] h-[30px] rounded-full mt-2" src="https://randomuser.me/api/portraits/men/1.jpg" alt="" />
          <div className="">
            <p className="text-white cursor-pointer">fulano</p>
            <p className="text-xs w-max text-gray-500">
              Followed by suodrifabeal + 12 more
            </p>
          </div>
          <div>
            <p className="ml-[100px] text-sm text-blue-500 cursor-pointer">
              Seguir
            </p>
          </div>
        </div>
        <div className="flex space-x-3">
          ...
          <div>
            <p className="ml-[82px] text-sm text-blue-500 cursor-pointer">
              Seguir
            </p>
          </div>
        </div>
        ...
        <div className="flex space-x-3">
          ...
          <div>
            <p className="ml-[96px] text-sm text-blue-500 cursor-pointer">
              Seguir
            </p>
          </div>
        </div>
        <div className="flex space-x-3">
          ...
          <div className="">
            <p className="text-white cursor-pointer">fulano</p>
            <p className="text-xs min-w-full text-gray-500">Suggested for you</p>
          </div>
          <div>
            <p className="ml-[188px] text-sm text-blue-500">Seguir</p>
          </div>
        </div>
      </div>
      <div className="py-4 space-y-2 text-gray-500">
        <footer>
