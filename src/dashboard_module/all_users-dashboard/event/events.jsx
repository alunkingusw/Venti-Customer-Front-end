        ...
        <div className="bg-white py-6 sm:py-8 lg:py-12">
            <div className="mx-auto max-w-screen-xl px-4 md:px-8">
                <div className="mb-10 md:mb-16">
                    <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Latest Happenings</h2>
                    <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">Explore the most recent and exciting events happening around you. Stay informed and engaged with our curated list of activities.</p>
                </div>
                ...
                <div className="grid gap-8 sm:grid-cols-2 sm:gap-12 lg:grid-cols-2 xl:grid-cols-2 xl:gap-16">
                    ...
                    <article className="flex flex-col items-center gap-4 md:flex-row lg:gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            <span className="text-sm text-gray-400">April 2, 2024</span>
